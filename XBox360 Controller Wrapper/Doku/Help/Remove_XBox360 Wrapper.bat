...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale de-de /uninstall /silent /vendor "Knerdprod" /mediaBookList "XBox360 Wrapper" /productName "XBox360 Wrapper"
